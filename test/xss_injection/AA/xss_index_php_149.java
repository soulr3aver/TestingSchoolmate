 ...
 * @author iono
 */
public class xss_index_php_149 {
    
    WebTester tester = new WebTester();
    
    public xss_index_php_149() {
    }  
    ...
    public void Attack_page2() {
        ...
        tester.setHiddenField("page2","15'> <a href=www.google.com>malicious link</a> <br '");
    ...
    public void Attack_page(){
        ...
        tester.assertMatch("Manage Users");
        tester.setWorkingForm("users");
        tester.setHiddenField("page2","15");
        tester.checkCheckbox("delete[]","1");
